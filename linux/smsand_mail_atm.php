...
$mclass = new sendSms();
$query=mysql_query("SELECT trans_id,shop_id,cust_id,email_id,customer_name,shop_name,amount,sms_status,email_status,trans_no,shop_code,contact_no,service_type,
location,ce_id,collection_date,collection_time FROM rcms_sms_mail_console WHERE status='Y' ");
